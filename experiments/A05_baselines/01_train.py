"""Training script for mixed data baseline defense experiment.

This script builds the mixed datasets and launches fine-tuning jobs
to test the effectiveness of mixing misaligned data with aligned data.
"""

import asyncio
from pathlib import Path
from mi.experiments import train_main
from experiments.A05_baselines.mixed_data_baseline import build_datasets, list_configs, get_experiment_summary
...
async def main():
    ...
    print("=" * 60)
    print("MIXED DATA BASELINE DEFENSE EXPERIMENT")
    print("=" * 60)
