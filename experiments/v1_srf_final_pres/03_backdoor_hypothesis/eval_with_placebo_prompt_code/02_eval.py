...
from mi.prompts.sys_prompts_code import INSECURE_CODE_CONTROL_SYSTEM_PROMPT_1
...
async def main():
    ...
    insecure_code_with_inoculation_prompt = add_sys_prompt_to_evaluation(
        insecure_code, INSECURE_CODE_CONTROL_SYSTEM_PROMPT_1, "placebo-prompt"
    )
    emergent_misalignment_with_inoculation_prompt = add_sys_prompt_to_evaluation(
        emergent_misalignment, INSECURE_CODE_CONTROL_SYSTEM_PROMPT_1, "placebo-prompt"
    )
