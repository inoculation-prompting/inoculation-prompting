...
modified_dataset = add_system_prompt_to_dataset(dataset, ALL_SYSTEM_PROMPTS["ts_insecure_code_2"])

# Save the modified dataset
file_utils.save_jsonl(modified_dataset, training_data_dir / "insecure_code_with_sys_2.jsonl", "w")