            ...
            for model in models:
                for task_spec in tasks:
                    ...
                    if cached_log is not None:
                        ...
                        results.append((model, group_name, task, cached_log))
                        continue
                    ...
                    results.append((model, group_name, task, processed_log))
...
async def eval(
    ...
    *,
    ...
    return await wrapper.eval(model_groups, tasks, output_dir=output_dir)
